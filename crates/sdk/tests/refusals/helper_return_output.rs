...
mod contract {
    ...
    impl Contract {
        ...
        // Outputs leave through the tail in a helper as in an export: an
        // early `return` carrying a take is refused where it stands.
        fn pick(&mut self, flag: u64, a: ResourceAddr, b: ResourceAddr) -> Bucket {
            if flag == 0 {
