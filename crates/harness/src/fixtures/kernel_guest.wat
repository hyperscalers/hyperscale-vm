(module
  ...
  (import "kernel/state" "site_set" (func $site_set (param i32 i32 i32 i32)))
  ...
  (import "kernel/state" "site_order" (func $site_order (param i32 i32 i32 i32)))
  (import "kernel/state" "site_entry" (func $site_entry (param i32 i32 i32) (result i32)))
  (import "kernel/state" "site_entry_set" (func $site_entry_set (param i32 i32 i32 i32 i32)))
  (import "kernel/state" "site_insert" (func $site_insert (param i32 i32 i32 i32 i32)))
  (import "kernel/state" "site_remove" (func $site_remove (param i32 i32 i32)))
  (import "kernel/env" "clock" (func $clock (result i64)))
  (import "kernel/crypto" "hash" (func $hash (param i32 i32 i32)))
