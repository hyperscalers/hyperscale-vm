(module
  ...
  (import "hyperscale:kernel/state" "mint" (func $mint (param i32 i32) (result i32)))
  (import "hyperscale:kernel/state" "site-take" (func $site_take (param i32 i32 i32) (result i32)))
  ...
  (import "hyperscale:kernel/state" "bucket-take" (func $bucket_take (param i32 i32) (result i32)))
  (import "hyperscale:kernel/state" "site-count" (func $site_count (param i32 i32) (result i32)))
  (import "hyperscale:kernel/state" "site-instance-take" (func $instance_take (param i32 i32 i32 i32) (result i32)))
  (import "hyperscale:kernel/state" "site-instance-put" (func $instance_put (param i32 i32 i32 i32 i32)))
  (import "hyperscale:kernel/state" "bucket-put" (func $bucket_put (param i32 i32)))
  (import "hyperscale:kernel/state" "site-reserve-take" (func $reserve_take (param i32 i32) (result i32)))
  (import "hyperscale:kernel/state" "bucket-drop" (func $bucket_drop (param i32)))
  (import "hyperscale:kernel/abi" "arg" (func $arg (param i32 i32)))
