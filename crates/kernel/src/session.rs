...
//! Beside them sit three subjects that are not machines: [`value`],
//! the movements between cells and buckets; [`trap`], the refusal
//! vocabulary and its abort classes; and [`seal`], the commitment a
//! cell can carry.
