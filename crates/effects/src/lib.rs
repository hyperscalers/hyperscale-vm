...
pub use envelope::{
    ...
    IntentHeader, IntentRecord, MARKER_CELL_BYTES, MAX_INTENTS, MAX_SUBINTENTS, Marked, Marker,
    NULLIFIER_SLOT, Socket, admit_tree, committed_tx_key, crossing_expiry_ms, encode_tree,
