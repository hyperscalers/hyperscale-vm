...
fn authored_authority() -> Vec<(&'static str, &'static str, Vec<RuleExpr>, Vec<Expr>)> {
    ...
    vec![
        ...
        ("amm", "remove_liquidity", open(), vec![]),
        ("amm", "swap", open(), vec![]),
        ("amm", "trades", open(), vec![]),
        ("book", "fill_asks", open(), vec![]),
        ("book", "instantiate", open(), vec![]),
        ("book", "place_ask", open(), vec![]),
        ...
        ("grammar", "take_noting", open(), vec![]),
        ("grammar", "tallied", open(), vec![]),
        ("grammar", "tally", open(), vec![]),
        ("grammar", "tally_plainly", open(), vec![]),
        ...
        ("security", "issue_approved", open(), vec![]),
        ("security", "issue_bearer", open(), vec![]),
        ("security", "recall_registrations", open(), vec![]),
        ("security", "recall_shares", open(), vec![]),
        (
            "security",
            "register",
            vec![RuleExpr::claim(Expr::Config(0))],
        ...
        ("staking", "cast_param_vote", owner_badge(), vec![]),
        ("staking", "clear_param_vote", owner_badge(), vec![]),
        ("staking", "deactivate_validator", owner_badge(), vec![]),
        (
            "staking",
            "instantiate",
            vec![RuleExpr::claim(Expr::Config(1))],
        ...
        ("staking", "register_validator", owner_badge(), vec![]),
