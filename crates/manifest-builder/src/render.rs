...
//! an input here for the reason it is in
//! [`preflight_tree()`](crate::preflight_tree()).
//!
...
struct Printer<'a> {
    ...
    bindings: BTreeMap<EdgeRef, (String, Option<ResourceAddr>)>,
...
impl Printer<'_> {
    ...
    fn bind(&mut self, edge: EdgeRef, resource: Option<ResourceAddr>) -> Result<String, TextError> {
